...
#define TCP_KEEPIDLE TCP_KEEPALIVE
	...
	class Socket{
		...
		public:
			...
			// Possable we can replace `char*` with an implementation of a IOBuffer object in future
	...
	inline void Socket::m_create_socket(){
		...
		_file_des = ::socket(static_cast<int>(_domain), static_cast<int>(_sock_type), 0);
