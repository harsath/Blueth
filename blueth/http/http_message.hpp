...
class http_request_message {
	...
	BLUETH_FORCE_INLINE constexpr bool
	...
	BLUETH_FORCE_INLINE constexpr void flush_body() noexcept;
	BLUETH_FORCE_INLINE constexpr void
	set_request_type(http_request_type type) noexcept;
	BLUETH_FORCE_INLINE constexpr http_request_type
	get_request_type() const noexcept;
	BLUETH_FORCE_INLINE constexpr void
	set_http_version(http_version version) noexcept;
	BLUETH_FORCE_INLINE constexpr http_version
	get_http_version() const noexcept;
	BLUETH_FORCE_INLINE constexpr void
	set_http_target_resource(std::string &&target_resource) noexcept;
	BLUETH_FORCE_INLINE constexpr const std::string &
	...
	// parser
	BLUETH_FORCE_INLINE constexpr void
	push_back_header_value(char char_val) noexcept;
	BLUETH_FORCE_INLINE constexpr void
	push_back_header_name(char char_val) noexcept;
	BLUETH_FORCE_INLINE constexpr void
	add_temp_header_holder_to_message() noexcept;
	BLUETH_FORCE_INLINE constexpr void
...
BLUETH_FORCE_INLINE constexpr void http_request_message::flush_body() noexcept {
	raw_body_->clear();
}
...
BLUETH_FORCE_INLINE constexpr void
http_request_message::set_http_target_resource(
...
void http_request_message::set_raw_body(
...
std::string http_request_message::build_raw_message() const noexcept {
	std::string returner;
