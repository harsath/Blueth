...
BLUETH_FORCE_INLINE std::unique_ptr<http_request_message>
...
BLUETH_FORCE_INLINE void http_request_message::flush_body() noexcept {
	raw_body_->clear();
}
...
BLUETH_FORCE_INLINE http_request_type
...
BLUETH_FORCE_INLINE http_version
